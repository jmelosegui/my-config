return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<Leader>lp",
            function() vim.cmd("lua require'dap'.set_breakpoint(nil, nil, vim.fn.input('Log point message: '))") end,
            { silent = true })
        vim.keymap.set("n", "<Leader>dr", function() vim.cmd("lua require'dap'.repl.open()") end, { silent = true })
        vim.keymap.set("n", "<Leader>dl", function() vim.cmd("lua require'dap'.run_last()") end, { silent = true })
    end
}
